...
export const CAKE_COATS = [
  ...
  // id совпадает с CAKE_CREAMS.butter/'butter-choco' не случайно — это тот же самый
  // масляный крем, просто выбранный на обмазку снаружи, а не между коржами. Общий id
  // даёт buildVirtualRecipe() найти настоящий рецепт cream:butter[-choco] по componentId
  // и вставить его реальные шаги, а не общую заглушку "приготовить покрытие".
  { id:'butter', label:'Масляный крем (ванильный)', c:'#F3E5C6', ingredient:['Масло сливочное (на обмазку снаружи)', 260, 'г'] },
  { id:'butter-choco', label:'Масляный крем (шоколадный)', c:'#7A4A2E', ingredient:['Масло сливочное (на обмазку снаружи)', 260, 'г'] },
